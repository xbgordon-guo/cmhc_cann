...
#include "../../../op_host/op_tiling/mhc_pre_cmhc_tiling.h"
#include "tiling_context_faker.h"
#include "tiling_case_executor.h"

using namespace std;

class CmhcTiling : public testing::Test {
protected:
    static void SetUpTestCase()
    {
        std::cout << "CmhcTiling SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "CmhcTiling TearDown" << std::endl;
    }
};

TEST_F(CmhcTiling, test_tiling_B1_S1024_N4_C512)
{
    int64_t B = 1;
    int64_t S = 1024;
    int64_t N = 4;
    ...
    optiling::CmhcCompileInfo compileInfo = {};
...
TEST_F(CmhcTiling, test_tiling_3d_S1024_N4_C512)
{
    int64_t T = 1024;
    int64_t N = 4;
    int64_t C = 512;
...
TEST_F(CmhcTiling, test_tiling_B2_S128_N4_C256)
{
    int64_t B = 2;
    int64_t S = 128;
    int64_t N = 4;
...
TEST_F(CmhcTiling, test_tiling_no_backward_B1_S256_N4_C512)
{
    int64_t B = 1;
    int64_t S = 256;
    int64_t N = 4;
