...
/*!
 * \file mhc_pre_cmhc_m_k_split_core.h
 * \brief
 */
...
template <typename T>
class MhcPreCmhcMembaseKSplitCorePart1 {
public:
    __aicore__ inline MhcPreCmhcMembaseKSplitCorePart1()
    {
    }

    __aicore__ inline void Init(GM_ADDR x, GM_ADDR hcFn, GM_ADDR workspace,
                                const MhcPreCmhcTilingData *tilingDataPtr, TPipe *pipePtr, int64_t bsOffset, int64_t curBs, bool isTailBsLoop = false)
    {
        pipe = pipePtr;
...
template <typename T>
class MhcPreCmhcMembaseKSplitCorePart2 {
public:
    __aicore__ inline MhcPreCmhcMembaseKSplitCorePart2()
    {
    }
    ...
    __aicore__ inline void Init(GM_ADDR x, GM_ADDR hcScale, GM_ADDR hcBase, GM_ADDR y,
                                ...
                                GM_ADDR workspace,
                                const MhcPreCmhcTilingData *tilingDataPtr, TPipe *pipePtr, int64_t bsOffset, bool isTailBsLoop = false)
    {
        pipe = pipePtr;
        tilingData = tilingDataPtr;
