...
/*!
 * \file mhc_pre_cmhc_m_k_split_core_arch35.h
 * \brief
 */

#ifndef CMHC_M_K_SPLIT_CORE_ARCH35_H
#define CMHC_M_K_SPLIT_CORE_ARCH35_H
...
template <typename T>
class CmhcMKSplitCorePart1 {
public:
    __aicore__ inline CmhcMKSplitCorePart1()
    {}
...
template <typename T>
class CmhcMKSplitCorePart2 {
public:
    __aicore__ inline CmhcMKSplitCorePart2()
    {}
