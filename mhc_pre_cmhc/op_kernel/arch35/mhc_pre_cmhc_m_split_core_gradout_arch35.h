...
/*!
 * \file mhc_pre_cmhc_m_split_core_gradout_arch35.h
 * \brief
 */

#ifndef CMHC_M_SPLIT_CORE_GRADOUT_ARCH35_H
#define CMHC_M_SPLIT_CORE_GRADOUT_ARCH35_H
...
template <typename T>
class CmhcMSplitCorePart1Gradout {
public:
    __aicore__ inline CmhcMSplitCorePart1Gradout()
    {
    }
    ...
    __aicore__ inline void Init(GM_ADDR x, GM_ADDR hcFn, GM_ADDR hcScale, GM_ADDR hcBase, GM_ADDR y, GM_ADDR post,
                                ...
                                GM_ADDR normOut, const CmhcRegbaseTilingData *tilingDataPtr, TPipe *pipePtr)
    {
        pipe = pipePtr;
