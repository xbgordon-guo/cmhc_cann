...
/*!
 * \file mhc_pre_cmhc_tiling_arch35.cpp
 * \brief
 */
...
CmhcTilingRegbase::CmhcTilingRegbase(gert::TilingContext *tilingContext) : context_(tilingContext)
{
}

ge::graphStatus CmhcTilingRegbase::GetPlatformInfo()
{
...
ge::graphStatus CmhcTilingRegbase::GetAttr()
{
...
ge::graphStatus CmhcTilingRegbase::GetShapeAttrsInfoInner()
{
...
ge::graphStatus CmhcTilingRegbase::CalcRegbaseOpTiling()
{
...
ge::graphStatus CmhcTilingRegbase::CalcRegbaseOpGradoutTiling()
{
    rowOfFormerBlock_ = CeilDiv(bs_, static_cast<int64_t>(aivCoreNum_));
    usedCoreNums_ = std::min(CeilDiv(bs_, rowOfFormerBlock_), static_cast<int64_t>(aivCoreNum_));
    rowOfTailBlock_ = bs_ - (usedCoreNums_ - 1) * rowOfFormerBlock_;
...
ge::graphStatus CmhcTilingRegbase::CalcMKSplitCorePart2Tiling()
{
    uint64_t kUbSize = tilingData_.get_kL1Size() / 2; // 先按2倍系数计算，m最大256，需保证kub小于256
    uint64_t mUbSize = CeilDiv(tilingData_.get_mL1Size(), 2);
...
ge::graphStatus CmhcTilingRegbase::CalcMKSplitCorePart2GradoutTiling()
{
    uint64_t kUbSize = tilingData_.get_kL1Size() / 2; // 先按2倍系数计算，m最大256，需保证kub小于256
    uint64_t mUbSize = CeilDiv(tilingData_.get_mL1Size(), 2);
...
ge::graphStatus CmhcTilingRegbase::CalcOpTiling()
{
...
ge::graphStatus CmhcTilingRegbase::DoOpTiling()
{
...
ge::graphStatus CmhcTilingRegbase::GetWorkspaceSize()
{
...
ge::graphStatus CmhcTilingRegbase::PostTiling()
{
