...
/*!
 * \file mhc_pre_cmhc_infershape.cpp
 * \brief MhcPreCmhc infershape implementation
 */
...
static ge::graphStatus InferShapeForCmhc(gert::InferShapeContext *context)
{
    OP_LOGD(context->GetNodeName(), "Begin to do MhcPreCmhc infershape.");
    ...
    OP_LOGD(context->GetNodeName(), "End to do MhcPreCmhc infershape.");
    return ge::GRAPH_SUCCESS;
}

static ge::graphStatus InferDataTypeForCmhc(gert::InferDataTypeContext *context)
{
    OP_LOGD(context->GetNodeName(), "Begin to do MhcPreCmhc infer datatype.");
    ...
    OP_LOGD(context->GetNodeName(), "End to do MhcPreCmhc infer datatype.");
    return ge::GRAPH_SUCCESS;
}

IMPL_OP_INFERSHAPE(MhcPreCmhc)
    .InferShape(InferShapeForCmhc)
    .InferDataType(InferDataTypeForCmhc);
