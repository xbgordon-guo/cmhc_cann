...
/*!
 * \file cmhc_infershape.cpp
 * \brief Cmhc infershape implementation
 */
...
{
    OP_LOGD(context->GetNodeName(), "Begin to do Cmhc infershape.");
    ...
    OP_LOGD(context->GetNodeName(), "End to do Cmhc infershape.");
    return ge::GRAPH_SUCCESS;
}

static ge::graphStatus InferDataTypeForCmhc(gert::InferDataTypeContext *context)
{
    OP_LOGD(context->GetNodeName(), "Begin to do Cmhc infer datatype.");
    ...
    OP_LOGD(context->GetNodeName(), "End to do Cmhc infer datatype.");
    return ge::GRAPH_SUCCESS;
}

IMPL_OP_INFERSHAPE(Cmhc)
