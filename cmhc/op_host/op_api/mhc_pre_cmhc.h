...
/*!
 * \file mhc_pre_cmhc.h
 * \brief MhcPreCmhc L0 kernel interface
 */

#ifndef PTA_NPU_OP_API_INC_LEVEL0_OP_MHC_PRE_CMHC_OP_H_
#define PTA_NPU_OP_API_INC_LEVEL0_OP_MHC_PRE_CMHC_OP_H_
...
#endif // PTA_NPU_OP_API_INC_LEVEL0_OP_MHC_PRE_CMHC_OP_H_
