...
/*!
 * \file cmhc.h
 * \brief Cmhc L0 kernel interface
 */

#ifndef PTA_NPU_OP_API_INC_LEVEL0_OP_CMHC_OP_H_
#define PTA_NPU_OP_API_INC_LEVEL0_OP_CMHC_OP_H_
...
#endif // PTA_NPU_OP_API_INC_LEVEL0_OP_CMHC_OP_H_
