...
/*!
 * \file aclnn_mhc_pre_cmhc.h
 * \brief MhcPreCmhc ACLNN API
 */

#ifndef OP_API_INC_LEVEL2_ACLNN_CMHC_H_
#define OP_API_INC_LEVEL2_ACLNN_CMHC_H_
...
/**
 * @brief aclnnCmhcGetWorkspaceSize的第一段接口，计算workspace大小。
...
/**
 * @brief aclnnCmhc的第二段接口，用于执行计算。
 */
aclnnStatus aclnnMhcPreCmhc(void *workspace, uint64_t workspaceSize, aclOpExecutor *executor,
                                aclrtStream stream);
...
#endif // OP_API_INC_LEVEL2_ACLNN_CMHC_H_
