...
/*!
 * \file mcmhc_sinkhorn_tiling.cpp
 * \brief Cmhc tiling implementation
 */

#include <sstream>
#include "cmhc_tiling.h"
...
static void PrintTilingData(const gert::TilingContext* context, CmhcTilingData& tiling)
{
    OP_LOGD(context->GetNodeName(), ">>>>>>>>>> Start to print Cmhc tiling data <<<<<<<<<<");
...
{
    OP_CHECK_IF(context == nullptr, OP_LOGE("Cmhc", "Tiling context is null"),
               return ge::GRAPH_FAILED);
