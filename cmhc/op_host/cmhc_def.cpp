...
/*!
 * \file mmcmhc_sinkhorn_sinkhorn_def.cpp
 * \brief Cmhc op host config
 */

#include "register/op_def_registry.h"

namespace ops {
class Cmhc : public OpDef {
public:
    explicit Cmhc(const char *name) : OpDef(name)
    {
        this->Input("x")
            .ParamType(REQUIRED)
        ...
        regbaseCfg.DynamicCompileStaticFlag(true)
            ...
            .ExtendCfgInfo("opFile.value", "cmhc_apt");
