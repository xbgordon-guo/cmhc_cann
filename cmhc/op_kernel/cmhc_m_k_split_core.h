...
#ifndef CMHC_M_K_SPLIT_A3_CORE_H
#define CMHC_M_K_SPLIT_A3_CORE_H
...
template <typename T>
class CmhcMembaseKSplitCorePart1 {
public:
    __aicore__ inline CmhcMembaseKSplitCorePart1()
    {
    }

    __aicore__ inline void Init(GM_ADDR x, GM_ADDR hcFn, GM_ADDR workspace,
                                const CmhcTilingData *tilingDataPtr, TPipe *pipePtr, int64_t bsOffset, int64_t curBs, bool isTailBsLoop = false)
    {
        pipe = pipePtr;
...
template <typename T>
class CmhcMembaseKSplitCorePart2 {
public:
    __aicore__ inline CmhcMembaseKSplitCorePart2()
    {
    }
    ...
    __aicore__ inline void Init(GM_ADDR x, GM_ADDR hcScale, GM_ADDR hcBase, GM_ADDR y,
                                ...
                                GM_ADDR workspace,
                                const CmhcTilingData *tilingDataPtr, TPipe *pipePtr, int64_t bsOffset, bool isTailBsLoop = false)
    {
        pipe = pipePtr;
        tilingData = tilingDataPtr;
