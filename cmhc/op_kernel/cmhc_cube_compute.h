...
/*!
 * \file cmhc_cube_compute.h
 * \brief
 */
#ifndef CMHC_CUBE_COMPUTE_H
#define CMHC_CUBE_COMPUTE_H
...
#define CMHC_CUBE_COMPUTE_SPLIT_K_TEMPLATE_PARAM template <bool enableSquareSum>
#define CMHC_CUBE_COMPUTE_SPLIT_K_TEMPLATE_CLASS HcCubeComputeSplitK<enableSquareSum>
#define CMHC_CUBE_COMPUTE_TEMPLATE_PARAM template<typename T>
#define CMHC_CUBE_COMPUTE_TEMPLATE_CLASS HcCubeCompute<T>

// 切K使用的矩阵乘实现
CMHC_CUBE_COMPUTE_SPLIT_K_TEMPLATE_PARAM
...
CMHC_CUBE_COMPUTE_SPLIT_K_TEMPLATE_PARAM
__aicore__ inline void CMHC_CUBE_COMPUTE_SPLIT_K_TEMPLATE_CLASS::Init(const GlobalTensor<float>& xGm, const GlobalTensor<float>& phiGm, TPipe *tpipe)
{
    phiGm_ = phiGm;
...
CMHC_CUBE_COMPUTE_SPLIT_K_TEMPLATE_PARAM
__aicore__ inline void CMHC_CUBE_COMPUTE_SPLIT_K_TEMPLATE_CLASS::CopyInA1(
    uint64_t kL1Size,
    const GlobalTensor<float> &aGlobal, const LocalTensor<float> &al1Local, const MmParams &mmParams)
{
...
CMHC_CUBE_COMPUTE_SPLIT_K_TEMPLATE_PARAM
__aicore__ inline void CMHC_CUBE_COMPUTE_SPLIT_K_TEMPLATE_CLASS::CopyInB1(
    uint64_t mGmOffset, uint64_t kGmOffset, uint64_t kL1Size, const MmParams &mmParams)
{
...
CMHC_CUBE_COMPUTE_SPLIT_K_TEMPLATE_PARAM
__aicore__ inline void CMHC_CUBE_COMPUTE_SPLIT_K_TEMPLATE_CLASS::CopyOut(const AscendC::GlobalTensor<float> &workspaceGlobal,
    const AscendC::LocalTensor<float> &c1Local, uint64_t baseM, uint64_t baseN, bool enableNz2Nd, uint64_t N)
{
...
CMHC_CUBE_COMPUTE_SPLIT_K_TEMPLATE_PARAM
__aicore__ inline void CMHC_CUBE_COMPUTE_SPLIT_K_TEMPLATE_CLASS::Fixp(const AscendC::GlobalTensor<float> &workspaceGlobalA2,
    const AscendC::GlobalTensor<float> &workspaceGlobalAB, const MmParams &mmParams)
{
    // Copy MmadA2
...
CMHC_CUBE_COMPUTE_SPLIT_K_TEMPLATE_PARAM
__aicore__ inline void CMHC_CUBE_COMPUTE_SPLIT_K_TEMPLATE_CLASS::SetBL1Mte1ToMte2Flag()
{
...
CMHC_CUBE_COMPUTE_SPLIT_K_TEMPLATE_PARAM
__aicore__ inline void CMHC_CUBE_COMPUTE_SPLIT_K_TEMPLATE_CLASS::WaitBL1Mte1ToMte2Flag()
{
    WaitFlag<HardEvent::MTE1_MTE2>(B_MTE1_MTE2_EVENT + l1bLoopIdx_ % L1_BUF_NUM);
}

CMHC_CUBE_COMPUTE_SPLIT_K_TEMPLATE_PARAM
__aicore__ inline void CMHC_CUBE_COMPUTE_SPLIT_K_TEMPLATE_CLASS::ComputeDecode(
...
CMHC_CUBE_COMPUTE_SPLIT_K_TEMPLATE_PARAM
__aicore__ inline void CMHC_CUBE_COMPUTE_SPLIT_K_TEMPLATE_CLASS::End()
{
    for (int i = 0; i < L0A_BUF_NUM; i++) {
...
CMHC_CUBE_COMPUTE_SPLIT_K_TEMPLATE_PARAM
__aicore__ inline void CMHC_CUBE_COMPUTE_SPLIT_K_TEMPLATE_CLASS::LoadAToL0A(
    uint64_t kL1Offset, uint64_t kL0Size, uint64_t l1LoopIdx, const MmParams &mmParams)
{
...
CMHC_CUBE_COMPUTE_SPLIT_K_TEMPLATE_PARAM
__aicore__ inline void CMHC_CUBE_COMPUTE_SPLIT_K_TEMPLATE_CLASS::LoadAToL0B(
    uint64_t kL1Offset, uint64_t kL0Size, uint64_t l1LoopIdx, const MmParams &mmParams)
{
    // mk nz -> m,k zz
...
CMHC_CUBE_COMPUTE_SPLIT_K_TEMPLATE_PARAM
__aicore__ inline void CMHC_CUBE_COMPUTE_SPLIT_K_TEMPLATE_CLASS::MmadA2(
    uint64_t kGmOffset, uint64_t kL0Size, bool isLastK, const MmParams &mmParams)
{
...
CMHC_CUBE_COMPUTE_SPLIT_K_TEMPLATE_PARAM
__aicore__ inline void CMHC_CUBE_COMPUTE_SPLIT_K_TEMPLATE_CLASS::LoadBToL0B(
    uint64_t kL1Offset, uint64_t kL0Size, uint64_t l1LoopIdx, const MmParams &mmParams)
{
    LoadData2DParams l1ToL0bParams;
    l1ToL0bParams.startIndex = 0;
...
CMHC_CUBE_COMPUTE_SPLIT_K_TEMPLATE_PARAM
__aicore__ inline void CMHC_CUBE_COMPUTE_SPLIT_K_TEMPLATE_CLASS::MmadAB(
    uint64_t kGmOffset, uint64_t kL0Size, bool isLastK, const MmParams &mmParams)
{
    SetFlag<HardEvent::MTE1_M>(MTE1_M_EVENT);
    WaitFlag<HardEvent::MTE1_M>(MTE1_M_EVENT);
...
// 不切K使用的矩阵乘实现
CMHC_CUBE_COMPUTE_TEMPLATE_PARAM
class HcCubeCompute {
public:
...
CMHC_CUBE_COMPUTE_TEMPLATE_PARAM
__aicore__ inline void CMHC_CUBE_COMPUTE_TEMPLATE_CLASS::Init(const GlobalTensor<float> &xGm,
...
CMHC_CUBE_COMPUTE_TEMPLATE_PARAM
__aicore__ inline void CMHC_CUBE_COMPUTE_TEMPLATE_CLASS::ProcessMatmulXPhi(const int32_t taskOffset, const int32_t mm1M)
{
    if (mm1M <= 0)
        return;
