...
/*!
 * \file mhc_pre_cmhc_m_k_split_core_gradout_arch35.h
 * \brief
 */

#ifndef CMHC_M_K_SPLIT_CORE_GRADOUT_ARCH35_H
#define CMHC_M_K_SPLIT_CORE_GRADOUT_ARCH35_H

#include "kernel_operator.h"
#include "mhc_pre_cmhc_base_arch35.h"
#include "mhc_pre_cmhc_cube_compute_arch35.h"

namespace CmhcNs {
using namespace AscendC;

template <typename T>
class CmhcMKSplitCorePart1Gradout {
public:
    __aicore__ inline CmhcMKSplitCorePart1Gradout()
    {}

    __aicore__ inline void Init(GM_ADDR x, GM_ADDR hcFn, GM_ADDR workspace,
        const CmhcRegbaseTilingData* tilingDataPtr, TPipe* pipePtr)
    {
        pipe = pipePtr;
...
private:
    TPipe* pipe;
    const CmhcRegbaseTilingData* tilingData;
    // (M, K) * (N, K)
...
template <typename T>
class CmhcMKSplitCorePart2Gradout {
public:
    __aicore__ inline CmhcMKSplitCorePart2Gradout()
    {}
