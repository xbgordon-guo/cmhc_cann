...
#include "cmhc_m_k_split_core.h"
#include "cmhc_m_split_core.h"
#include "cmhc_base.h"
using namespace Cmhc;
                                             ...
                                             GM_ADDR workspace, GM_ADDR tiling)
{
    ...
    GET_TILING_DATA_WITH_STRUCT(CmhcTilingData, tiling_data_in, tiling);
    const CmhcTilingData *__restrict tilingData = &tiling_data_in;

    if (TILING_KEY_IS(0)) {
        // -----------split m--------------
        TPipe pipe;
        Cmhc::CmhcStage1<DTYPE_X> op1;
